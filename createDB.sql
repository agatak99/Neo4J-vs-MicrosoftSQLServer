...
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 9)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 10)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 9)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 4), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 6), (SELECT $node_id FROM Vehicle WHERE ID = 12)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 13)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 19), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 20), (SELECT $node_id FROM Vehicle WHERE ID = 14)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 15)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 15)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 16)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 11)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 17)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 18)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 19)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 20)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 21)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 22)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 22)),
((SELECT $node_id FROM Film WHERE ID = 19), (SELECT $node_id FROM Vehicle WHERE ID = 23)),
((SELECT $node_id FROM Film WHERE ID = 2), (SELECT $node_id FROM Vehicle WHERE ID = 24)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 26)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 27)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 28)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 29)),
((SELECT $node_id FROM Film WHERE ID = 19), (SELECT $node_id FROM Vehicle WHERE ID = 30)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 31)),
((SELECT $node_id FROM Film WHERE ID = 9), (SELECT $node_id FROM Vehicle WHERE ID = 32)),
((SELECT $node_id FROM Film WHERE ID = 10), (SELECT $node_id FROM Vehicle WHERE ID = 33)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 34)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 35)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 36)),
((SELECT $node_id FROM Film WHERE ID = 2), (SELECT $node_id FROM Vehicle WHERE ID = 37)),
((SELECT $node_id FROM Film WHERE ID = 6), (SELECT $node_id FROM Vehicle WHERE ID = 38)),
((SELECT $node_id FROM Film WHERE ID = 12), (SELECT $node_id FROM Vehicle WHERE ID = 38)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 39)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 40)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 41)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 42)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 43)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 44)),
((SELECT $node_id FROM Film WHERE ID = 4), (SELECT $node_id FROM Vehicle WHERE ID = 44)),
((SELECT $node_id FROM Film WHERE ID = 4), (SELECT $node_id FROM Vehicle WHERE ID = 45)),
((SELECT $node_id FROM Film WHERE ID = 4), (SELECT $node_id FROM Vehicle WHERE ID = 43)),
((SELECT $node_id FROM Film WHERE ID = 4), (SELECT $node_id FROM Vehicle WHERE ID = 46)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 48)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 49)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 43)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 50)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 51)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 52)),
((SELECT $node_id FROM Film WHERE ID = 10), (SELECT $node_id FROM Vehicle WHERE ID = 53)),
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 54)),
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 52)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 55)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 56)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 57)),
((SELECT $node_id FROM Film WHERE ID = 20), (SELECT $node_id FROM Vehicle WHERE ID = 43)),
((SELECT $node_id FROM Film WHERE ID = 20), (SELECT $node_id FROM Vehicle WHERE ID = 58)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 59)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 60)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 61)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 62)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 63)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 64)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 65)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 66)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 67)),
((SELECT $node_id FROM Film WHERE ID = 2), (SELECT $node_id FROM Vehicle WHERE ID = 68)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 69)),
((SELECT $node_id FROM Film WHERE ID = 8), (SELECT $node_id FROM Vehicle WHERE ID = 70)),
((SELECT $node_id FROM Film WHERE ID = 8), (SELECT $node_id FROM Vehicle WHERE ID = 71)),
((SELECT $node_id FROM Film WHERE ID = 8), (SELECT $node_id FROM Vehicle WHERE ID = 72)),
((SELECT $node_id FROM Film WHERE ID = 8), (SELECT $node_id FROM Vehicle WHERE ID = 73)),
((SELECT $node_id FROM Film WHERE ID = 8), (SELECT $node_id FROM Vehicle WHERE ID = 74)),
((SELECT $node_id FROM Film WHERE ID = 11), (SELECT $node_id FROM Vehicle WHERE ID = 75)),
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 76)),
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 77)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 78)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 79)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 80)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 81)),
((SELECT $node_id FROM Film WHERE ID = 20), (SELECT $node_id FROM Vehicle WHERE ID = 82)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 83)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 84)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 85)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 86)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 87)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 83)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 88)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 89)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 90)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 89)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 91)),
((SELECT $node_id FROM Film WHERE ID = 21), (SELECT $node_id FROM Vehicle WHERE ID = 92)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 92)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 93)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 94)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 95)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 96)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 92)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 97)),
((SELECT $node_id FROM Film WHERE ID = 10), (SELECT $node_id FROM Vehicle WHERE ID = 98)),
((SELECT $node_id FROM Film WHERE ID = 12), (SELECT $node_id FROM Vehicle WHERE ID = 99)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 100)),
((SELECT $node_id FROM Film WHERE ID = 6), (SELECT $node_id FROM Vehicle WHERE ID = 101)),
((SELECT $node_id FROM Film WHERE ID = 6), (SELECT $node_id FROM Vehicle WHERE ID = 102)),
((SELECT $node_id FROM Film WHERE ID = 7), (SELECT $node_id FROM Vehicle WHERE ID = 102)),
((SELECT $node_id FROM Film WHERE ID = 9), (SELECT $node_id FROM Vehicle WHERE ID = 103)),
((SELECT $node_id FROM Film WHERE ID = 12), (SELECT $node_id FROM Vehicle WHERE ID = 104)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 102)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 105)),
((SELECT $node_id FROM Film WHERE ID = 15), (SELECT $node_id FROM Vehicle WHERE ID = 106)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 107)),
((SELECT $node_id FROM Film WHERE ID = 18), (SELECT $node_id FROM Vehicle WHERE ID = 108)),
((SELECT $node_id FROM Film WHERE ID = 23), (SELECT $node_id FROM Vehicle WHERE ID = 109)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 110)),
((SELECT $node_id FROM Film WHERE ID = 2), (SELECT $node_id FROM Vehicle WHERE ID = 111)),
((SELECT $node_id FROM Film WHERE ID = 3), (SELECT $node_id FROM Vehicle WHERE ID = 112)),
((SELECT $node_id FROM Film WHERE ID = 6), (SELECT $node_id FROM Vehicle WHERE ID = 113)),
((SELECT $node_id FROM Film WHERE ID = 9), (SELECT $node_id FROM Vehicle WHERE ID = 113)),
((SELECT $node_id FROM Film WHERE ID = 11), (SELECT $node_id FROM Vehicle WHERE ID = 113)),
((SELECT $node_id FROM Film WHERE ID = 12), (SELECT $node_id FROM Vehicle WHERE ID = 114)),
((SELECT $node_id FROM Film WHERE ID = 13), (SELECT $node_id FROM Vehicle WHERE ID = 112)),
((SELECT $node_id FROM Film WHERE ID = 14), (SELECT $node_id FROM Vehicle WHERE ID = 116)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 113)),
((SELECT $node_id FROM Film WHERE ID = 19), (SELECT $node_id FROM Vehicle WHERE ID = 113)),
((SELECT $node_id FROM Film WHERE ID = 24), (SELECT $node_id FROM Vehicle WHERE ID = 111)),
((SELECT $node_id FROM Film WHERE ID = 1), (SELECT $node_id FROM Vehicle WHERE ID = 117)),
((SELECT $node_id FROM Film WHERE ID = 5), (SELECT $node_id FROM Vehicle WHERE ID = 118)),
((SELECT $node_id FROM Film WHERE ID = 11), (SELECT $node_id FROM Vehicle WHERE ID = 119)),
((SELECT $node_id FROM Film WHERE ID = 16), (SELECT $node_id FROM Vehicle WHERE ID = 120)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 121)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 21)),
((SELECT $node_id FROM Film WHERE ID = 17), (SELECT $node_id FROM Vehicle WHERE ID = 122)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 123)),
((SELECT $node_id FROM Film WHERE ID = 22), (SELECT $node_id FROM Vehicle WHERE ID = 124));
